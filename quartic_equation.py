...
class QuarticEquation(Scene):
    def construct(self):
        ...
        a7 = MathTex(
            ...
            r"&r=", r"{16ab^2c-64a^2bd-3b^4+256a^3e\over 256a^4}"
        ).move_to(UP*6.75)
        ...
        a19 = MathTex(
            ...
            r"&\bigg(y^2", r"+p+z", r"+\sqrt{p+2z}\ y-\frac{q}{2\sqrt{p+2z}}", r"\bigg)=0"
        ).move_to(-1.8*UP)
        a20 = MathTex(
            r"&\bigg(y^2", r"-\sqrt{p+2z}\ y+\frac{q}{2\sqrt{p+2z}}", r"+p+z", r"\bigg)\cdot\\",
            r"&\bigg(y^2", r"+\sqrt{p+2z}\ y-\frac{q}{2\sqrt{p+2z}}", r"+p+z", r"\bigg)=0"
        ).move_to(-1.8*UP)
        a21 = MathTex(
        ...
        a22 = MathTex(
            ...
            r"&y_{3,4}=-\frac{\sqrt{p+2z}}2\pm\sqrt{\frac{q}{2\sqrt{p+2z}}-\frac{3p+2z}4}"
        ).move_to(-1.8*UP)
        a23 = MathTex(
            r"x_{1,2}=-\frac{b}{4a}+\frac{\sqrt{p+2z}}2\pm\sqrt{\frac{-q}{2\sqrt{p+2z}}-\frac{3p+2z}4}\\",
            r"x_{3,4}=-\frac{b}{4a}-\frac{\sqrt{p+2z}}2\pm\sqrt{\frac{q}{2\sqrt{p+2z}}-\frac{3p+2z}4}"
        ).scale(0.9).move_to(-1.8*UP)
        ...
        self.wait(0.5)
        self.play(
            ReplacementTransform(a4[:2], a5[0]), 
            ReplacementTransform(a4[2], a5[1]),
            ReplacementTransform(a4[3:5], a5[2]), 
            ReplacementTransform(a4[5], a5[3]),
            ReplacementTransform(a4[6], a5[4]), 
            ReplacementTransform(a4[7:9], a5[5]),
            TransformMatchingShapes(a4[9:12], a5[6])
        )
        self.wait(0.5)
        ...
        self.play(
            ...
            ReplacementTransform(b6[1:4], a8[1]),
            ReplacementTransform(b6[4], a8[2]),
            ReplacementTransform(b6[5:8], a8[3]),
        ...
        self.play(
            ...
            *[ReplacementTransform(a11[i], a12[i+1]) for i in range(1, 6)]
        )
        ...
        self.wait(0.5)
        self.play(
            TransformFromCopy(a13[5], a13[11]), 
            TransformFromCopy(a13[2], a13[14]), 
            TransformFromCopy(a13[7], a13[16])
        )
        self.wait(0.5)
        self.play(ReplacementTransform(a13[9:18], a14))
        self.wait(0.5)
        ...
        self.wait(0.5)
        self.play(TransformMatchingShapes(a20[:4], a21[0]), TransformMatchingShapes(a20[4:8], a21[1]))
        self.wait(0.5)
