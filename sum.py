...
class MyScene(Scene):
    def construct(self):
        ...
        self.wait()
        self.play(Rotate(g, angle=PI, about_point=[0, 0.65, 0]), FadeIn(VGroup(a[0:2], a[7], a[8])))
        self.wait()
        ...
        self.play(
            a[2:7].animate.move_to(a7[0].get_center()),
            a[9:11].animate.move_to(a7[2].get_center()),
        ...
        self.play(
            ...
            ReplacementTransform(VGroup(a[2:7], a7[0]), a8[0])
        )
        self.wait()
