...
class area_of_a_circle(Scene):
    ...
    def construct(self):
        ...
        self.play(*[Write(i) for i in (r, r_line)])
        self.play(*[Transform(i.copy(), i.target) for i in (r_line, r)])

        self.play(*[Write(i) for i in (chuvi, perimeter)])
        self.play(*[Transform(i.copy(), i.target) for i in (perimeter, chuvi)])
